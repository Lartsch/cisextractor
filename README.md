...
**PLEASE NOTE:** Some AVs detect Go binaries as a trojan, especially on Windows machines (see [official statement](https://go.dev/doc/faq#virus)). This is a false positive. Please check the source and build script for yourself if you want to make sure.  
